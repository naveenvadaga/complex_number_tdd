...
class TestComplexNumbers(unittest.TestCase):
    ...
    def test_complex_number_phase_real_part(self):
        ...
        assert complex_number_one.phase() == 3.141592653589793

    def test_complex_number_phase_imaginary_part(self):
        complex_number_one = ComplexNumber(0, 1)
    ...
    def test_complex_number_polar_imaginary_part(self):
        ...
        assert complex_number_one.polar() == (2, -1.5707963267948966)

    def test_complex_number_polar_both_parts(self):
        complex_number_one = ComplexNumber(1, 1)
